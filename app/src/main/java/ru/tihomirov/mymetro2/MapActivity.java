...
import ru.tihomirov.mymetro2.settings.AlarmReceiver;
import ru.tihomirov.mymetro2.settings.CatalogList;
import ru.tihomirov.mymetro2.settings.CatalogManagement;
import ru.tihomirov.mymetro2.settings.SET;
import ru.tihomirov.mymetro2.settings.SettingsActivity;
import ru.tihomirov.mymetro2.map.Delay;
import ru.tihomirov.mymetro2.map.MapData;
import ru.tihomirov.mymetro2.map.TRP;
import ru.tihomirov.mymetro2.util.ContextMenuAdapter;
import ru.tihomirov.mymetro2.util.ContextMenuItem;
...
//            actvFrom.setThreshold(1);
    ...
    private void runMapSelect() {
        Intent intent;
        intent = new Intent(this, SettingsActivity.class);
        intent.putExtra( PreferenceActivity.EXTRA_SHOW_FRAGMENT, CatalogManagement.class.getName() );
